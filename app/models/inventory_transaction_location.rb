class InventoryTransactionLocation < ActiveRecord::Base
  
    #	===========================
  # 	Association declarations:
  #	===========================
    belongs_to :inventory_transaction_asset
    
 
  #	============================
  #	 Validations declarations:
  #	============================
#	validates_presence_of :inventory_transaction_asset_id
#	validates_presence_of :transaction_quantity
#	validates_presence_of :location_id
#	validates_numericality_of :inventory_transaction_asset_id
#	validates_numericality_of :transaction_quantity
