...
class ApplicationController < ActionController::Base
  ...
  before_filter :configure_charsets, :check_login, :except => [:list_load_voyages, :list_voyage_ports, :list_load_details, :render_list_order_products, :progress, :progress_test, :start_tasks_thread, :login, :messages, :invoke, :invoke_submit, :invoke_method_params, :wsdl, :api, :authenticate, :integrate, :symbol_pdt_6800, :handle_request, :get_bin, :set_user_message, :list_forecasts, :list_drenches, :list_drench_lines, :list_drench_concentrates, :list_concentrate_product_types, :get_production_runs_results, :get_stored_pdt_processes, :get_production_runs_farm_code, :get_production_runs_line_code, :get_production_runs_account_code, :get_stored_pdt_processes_user_process_name, :get_stored_pdt_processes_transaction_name, :get_temperature_device_type_list, :get_unit_type_list, :get_pallet_format_product_codes, :update_run_stats, :valid_trip_sheet, :complete_delivery, :valid_bin, :list_qc_inspection_types, :list_qc_reasons, :list_qc_inspection_type_tests, :list_qc_measurement_types, :list_qc_inspection_tests, :edit_qc_inspection, :render_commitment_form, :list_spray_results_form, :get_loading_vehicle_numbers, :get_offload_tripsheets, :change_password, :change_user_password, :webquery, :fta_reports_index, :view_last_fta_report, :search_fta_reports, :view_last_rfm_report, :search_rfm_reports, :print_current_fta_report, :view_fta_report, :print_current_rfm_report, :view_rfm_report, :submit_search_rfm_reports_search, :send_parameter_fields, :submit_search_fta_reports_search, :submit_search_rfm_reports_search, :get_active_run_details, :bins_scanned, :override_provided, :bin_tipped, :bin_created]
  after_filter :clear_lock, :except => [:list_load_voyages, :list_voyage_ports, :list_load_details, :render_list_order_products, :progress, :progress_test, :start_tasks_thread, :login, :messages, :invoke, :invoke_submit, :invoke_method_params, :wsdl, :api, :authenticate, :integrate, :symbol_pdt_6800, :handle_request, :get_bin, :set_user_message, :update_run_stats, :list_qc_inspection_types, :list_qc_reasons, :list_qc_inspection_type_tests, :list_qc_measurement_types, :list_qc_inspection_tests, :edit_qc_inspection, :render_commitment_form, :list_spray_results_form, :webquery, :get_active_run_details, :bins_scanned, :override_provided, :bin_tipped, :bin_created]
