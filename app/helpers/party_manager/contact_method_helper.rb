...
#	----------------------------------------------------------------------------------------------
 ...
 def build_parties_postal_address_grid(data_set,can_edit,can_delete)
	...
	column_configs[0] = {:field_type => 'text',:field_name => 'address1'}
	column_configs[1] = {:field_type => 'text',:field_name => 'address2'}
	column_configs[2] = {:field_type => 'text',:field_name => 'city'}
	column_configs[3] = {:field_type => 'text',:field_name => 'postal_address_type_code'}
...
#	----------------------------------------------------------------------------------------------
 ...
 def build_postal_address_grid(data_set,can_edit,can_delete)
	...
	column_configs[1] = {:field_type => 'text',:field_name => 'address2'}
	column_configs[2] = {:field_type => 'text',:field_name => 'city'}
	column_configs[3] = {:field_type => 'text',:field_name => 'postal_code'}
	column_configs[4] = {:field_type => 'text',:field_name => 'postal_address_type_code'}
#	----------------------
#	define action columns
#	----------------------
	if can_edit
		column_configs[column_configs.length()] = {:field_type => 'action',:field_name => 'edit postal_address',
			:settings => 
				 {:link_text => 'edit',
	...
	if can_delete
		column_configs[column_configs.length()] = {:field_type => 'action',:field_name => 'delete postal_address',
			:settings => 
				 {:link_text => 'delete',
