...
#	===========================
  ...
  attr_accessor :production_run_code,:ignore_cascade_ctn_updates,:product_size,:line_code,:actual_size_count_code,:season,:puc,:no_bags_insp,:no_fruit_insp,:brand_code,:product_weight,:commodity_code,:variety,:pick_reference,:batch_code
