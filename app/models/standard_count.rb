...
#	============================
	...
	validates_presence_of :marketing_size_range_mm
...
def validate_uniqueness
	 exists = StandardCount.find_by_commodity_code_and_standard_count_value(self.commodity_code,self.standard_count_value)
	 if exists != nil 
		errors.add_to_base("There already exists a record with the combined values of fields: 'standard_count_value' and 'commodity_code' ")
	end
end
#	===========================
