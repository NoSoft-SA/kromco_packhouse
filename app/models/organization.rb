class Organization < ActiveRecord::Base
  ...
  def after_destroy
    self.party.destroy if self.party
  ...
  # Get an Organization from a PartyRole or a party_role_id
  def self.find_using_party_role(party_role_or_id)
    party_role = party_role_or_id.respond_to?(:party_id) ? party_role_or_id : PartiesRole.find(party_role_or_id)
    Organization.find_by_party_id(party_role.party_id)
  end
