...
class PresortStagingRunPlugin < ApplicationHelper::GridPlugin
...
def cancel_cell_rendering(column_name, cell_value, record)
  ...
  #  return true
  #elsif column_name == "child_runs" && (!cell_value || cell_value == "false" || cell_value.to_s.strip == "")
  # return true
  #elsif column_name == "active_child_runs" && (!cell_value || cell_value == "false" || cell_value.to_s.strip == "")
  #   return true
  # elsif column_name == "editing_child_runs" && (!cell_value || cell_value == "false" || cell_value.to_s.strip == "")
  #   return true
  # elsif column_name == "staged_child_runs" && (!cell_value || cell_value == "false" || cell_value.to_s.strip == "")
  #   return true
  #else
  #  return false
  #end
