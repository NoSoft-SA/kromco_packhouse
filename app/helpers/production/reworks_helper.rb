...
#       bin_farm_group_code=Farm.find_by_sql("select farm_group_code from farms where id = #{bin.farm_id}")[0]['farm_group_code']
  ...
  def build_rw_bins_grid(data_set,tip_bins,scrap_bins)
    ...
    set_grid_min_width(1200)
    if tip_bins==nil && scrap_bins==nil
     return get_data_grid(data_set, column_configs, MesScada::GridPlugins::Production::ReworksReceivedBinsGrigPlugin.new,true)
    else
     return get_data_grid(data_set, column_configs)
    end
  end
...
#	----------------------
    ...
    return get_data_grid(data_set, column_configs, MesScada::GridPlugins::Production::ReworksReceivedPalletsPlugin.new)
