class RebinLabelStation < ActiveRecord::Base
  ...
  validates_presence_of :rebin_label_station_code
  validates_uniqueness_of :rebin_label_station_code
  ...
  def before_create
   ...
   prod_resource.resource_type_code = "rebin_label_station"
   prod_resource.resource_code = facility.facility_code + "_" + self.rebin_label_station_code
  ...
  def before_update
     facility = Facility.find_by_facility_code(self.packhouse_code)
     self.production_resource.resource_code = facility.facility_code + "_" + self.rebin_label_station_code
