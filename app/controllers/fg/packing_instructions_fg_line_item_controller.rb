...
def create_packing_instructions_fg_line_item
   @packing_instructions_fg_line_item = PackingInstructionsFgLineItem.new(params[:packing_instructions_fg_line_item])
   @packing_instructions_fg_line_item.packing_instruction_id = session[:active_doc]['pi']
...
def update_packing_instructions_fg_line_item
   ...
   if id && @packing_instructions_fg_line_item = PackingInstructionsFgLineItem.find(id)
     if @packing_instructions_fg_line_item.update_attributes(params[:packing_instructions_fg_line_item])
       render :inline =>
                  %{
                    "<script>
