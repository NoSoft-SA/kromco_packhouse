...
#    return result_screen
  ...
  def build_default_screen
     ...
     field_configs[field_configs.length] = {:type=>"drop_down",:name=>"destination",:is_required=>"true",:list => ", ,PACKHSE,RA_10,RA_1TO5,RA_6AND7,RA_8AND9,REWORKS,BAGGING,PART_PALLETS,CA_CDE_CA_D_35,RA_8AND9_RA_15,RA_8AND9_RA_16"}
