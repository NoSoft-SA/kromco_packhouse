...
#	----------------------------------------------------------------------------------------------
 ...
 def build_organization_grid(data_set,can_edit,can_delete)
	...
	column_configs = Array.new
	column_configs[0] = {:field_type => 'text',:field_name => 'long_description'}
	column_configs[1] = {:field_type => 'text',:field_name => 'medium_description'}
	column_configs[2] = {:field_type => 'text',:field_name => 'short_description',:column_caption => "org code"}
	column_configs[3] = {:field_type => 'text',:field_name => 'gln'}
	column_configs[4] = {:field_type => 'text',:field_name => 'sell_by_algorithm'}
	column_configs[5] = {:field_type => 'text',:field_name => 'sell_by_description'}
	column_configs[6] = {:field_type => 'text',:field_name => 'receives_edi'}
  column_configs[column_configs.length()] = {:field_type => 'action',:field_name => 'parent_org',
			:settings =>
				 {:link_text => 'parent',
				:target_action => 'parent_organization',
				:id_column => 'id'}}

  column_configs[column_configs.length()] = {:field_type => 'action',:field_name => 'child_orgs',
			:settings =>
				 {:link_text => 'children',
...
#	----------------------
	if can_edit
		column_configs[column_configs.length()] = {:field_type => 'action',:field_name => 'edit organization',
			:settings => 
				 {:link_text => 'edit',
	...
	if can_delete
		column_configs[column_configs.length()] = {:field_type => 'action',:field_name => 'delete organization',
			:settings => 
				 {:link_text => 'delete',
